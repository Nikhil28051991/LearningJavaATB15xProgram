...
public class Lab187_Poly_MethodOverloading {
    ...
    public static void main(String[] args) {
        ...
        String r4 = m1.add("nikhil", "sonawane");

        System.out.println(r1);                         // Prints: 7
        System.out.println(r2);                         // Prints: 13
        System.out.println(r3);                         // Prints: 7.7
        System.out.println(r4);                         // Prints: nikhilsonawane
    }
}
