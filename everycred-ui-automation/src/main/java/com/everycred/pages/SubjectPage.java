...
public class SubjectPage {
    ...
    // 🔥 GLOBAL CONTROL (FIX: prevents double navigation even if called again)
    ...
    // ======================================
    // 🔥 OVERLOADED FIX (RESOLVES YOUR ERROR)
    // ======================================
    ...
    // ======================================
    // NAVIGATE SUBJECTS (🔥 FIXED DUPLICATE ISSUE)
    // ======================================

    public void navigateToSubjects() {

        if (GLOBAL_SUBJECTS_LOADED) {
            System.out.println("Subjects already loaded → skipping navigation");
            return;
        }
    ...
    // ======================================
    // NAVIGATE + ONBOARDING (ONLY ONCE)
    // ======================================

    public void navigateToSubjectsAndHandleOnboarding() {

        if (subjectsNavigationHandled) {
            System.out.println("Navigation already executed → skipping second call");
            return;
        }
    ...
    // ======================================
    // CREATE GROUP (OPTIMIZED BUT STABLE)
    // ======================================
    ...
    public void createGroup() {
        ...
        wait.until(ExpectedConditions.or(
                ...
                ExpectedConditions.visibilityOfElementLocated(
                        By.xpath("//*[contains(@class,'p-toast-message') and contains(.,'Group')]"))
        ));
    ...
    public void createSubjectFlow() {
        ...
        selectFromDropdown(By.id("group"), "Employee Department");
    ...
    private void selectAttributeCheckbox(String attr) {
