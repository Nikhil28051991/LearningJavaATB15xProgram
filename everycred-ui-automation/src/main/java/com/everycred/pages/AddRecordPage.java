...
waitVisible(By.xpath("//span[normalize-space()='Add New Record']"));
...
WebElement addNewRecord = waitClickable(
...
// EMPLOYEE ID
WebElement empId = waitVisible(
         By.xpath("//tbody/tr/td[4]/div[1]/p-celleditor[1]/div[1]/input[1]"));

empId.sendKeys("VCEID-11111-0483604");                             //
delay();


// DESIGNATION
WebElement designation = waitVisible(
...
// PERSONAL EMAIL
WebElement personalEmail = waitVisible(
...
// CONTACT NUMBER
WebElement contactNumber = waitVisible(
...
// COMPANY URL
waitVisible(By.xpath("//input[@type='url']"))
        .sendKeys("https://viitorcloud.com/");
delay();


// ADDRESS
waitVisible(By.xpath("//tbody/tr/td[11]/div[1]/p-celleditor[1]/div[1]/input[1]"))
        .sendKeys("Ahmedabad, Gujarat");
delay();


// SAVE RECORD
WebElement tickButton = waitClickable(
...
By crossLocator = By.xpath("//span[contains(@class,'pi-times')]");
...
if (retry == 5) {
  throw new RuntimeException("Failed to click cross button after retries");
}
